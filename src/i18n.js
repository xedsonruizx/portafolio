...
const translations = {
  en: {
    ...
    about: { title: 'About Me', description: 'University Technical Degree in Computer Science from Universidad Técnica Federico Santa María, with over 4 years of experience in technology and banking. Specialized in Full Stack Development, Salesforce, and Manual QA. Skilled in Vue.js, React.js, Next.js, PHP Laravel, Python, Node.js, and Java with Spring Boot, along with databases such as MySQL, PostgreSQL, and Oracle SQL. Salesforce Administrator certified. Cambridge B2 English certificate (Upper-Intermediate). Results-driven, committed, and a strong team player.' },
  ...
  es: {
    ...
    about: { title: 'Sobre mí', description: 'Técnico Universitario en Informática titulado en la Universidad Técnica Federico Santa María, con más de 4 años de experiencia en los rubros de tecnología y banca. Especialización en desarrollo Full Stack, Salesforce y QA Manual. Conocimientos en Vue.js, React.js, Next.js, PHP Laravel, Python, Node.js y Java con Spring Boot, junto a bases de datos como MySQL, PostgreSQL y Oracle SQL. Certificación Salesforce Administrator. Inglés B2 certificado por Cambridge (Intermedio-Avanzado). Perfil orientado a resultados, comprometido y con capacidad de trabajo en equipo.' },
